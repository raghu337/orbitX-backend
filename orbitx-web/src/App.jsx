...
export default function App() {
  const [activeScreen, setActiveScreen] = useState('SpaceNotes');
  ...
  useEffect(() => {
    const handleNavigationMessage = (event) => {
      ...
      if (event.data.type === 'NAVIGATE_TO') {
        ...
        const validScreens = ['SpaceNotes', 'LiveTracking', 'SolarSystem3D', 'SpaceChat', 'LaunchTracker', 'Settings'];
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-[#02050c] text-slate-100 select-none relative font-sans">
      ...
      <div className="absolute top-[40%] right-[10%] w-[30%] h-[30%] rounded-full bg-cyber-cyan/5 blur-[120px] pointer-events-none z-0" />
