...
/**
 * PlanetDetail Screen
 * Shows comprehensive information about a selected planet
 */
const PlanetDetail = ({ route, navigation }) => {
 ...
 * Displays a single overview card with label and value
 */
...
/**
 * FactRow Component
 * Displays a fact row in the detailed facts table
 */
